    ...
    public static void main(String[] args) throws SocketException, IOException {
        ...
        while (true) {
            ...
            switch (line) {
                ...
                case "laycauhoi":
                    try {
                        ResultSet rs = db.Query("SELECT  TOP (10) [CAUHOI]\n"
                                + "      ,[NOIDUNG]\n"
                                + "      ,[A]\n"
                                + "      ,[B]\n"
                                + "      ,[C]\n"
                                + "      ,[D]\n"
                                + "	  FROM [LTM_GK].[dbo].[BODE] ORDER BY NEWID()");
                        while (rs.next()) {
                            question = new CauHoi();
                ...
                case "dangky":
                    ...
                    try {
                        //kiem tra xem ma sinh vien co bi trung
                    ...
                    try {
                        //kiem tra xem sdt sinh vien co bi trung 
